    ...
    <div style="display: inline-block; width: 65%; height: 500px; padding: 10px; border: 1px solid #ddd; overflow: auto; float: right">
        <fieldset class="layui-elem-field site-demo-button">
            ...
            <div class="demoTable" style="display: inline-block; margin-bottom: 10px; margin-top: 10px">
                <button class="layui-btn" onclick="add('add')"> <i class="layui-icon">&#xe654;</i>添加菜单</button>
                <button class="layui-btn layui-btn-normal" onclick="add('edit')"> <i class="layui-icon">&#xe642;</i>编辑菜单</button>
                <button class="layui-btn layui-btn-warm" onclick="add('view')"> <i class="layui-icon">&#xe621;</i>查看菜单</button>
                <button class="layui-btn  layui-btn-danger" onclick="del()"> <i class="layui-icon">&#xe640;</i>删除菜单</button>
            </div>
        </fieldset>
