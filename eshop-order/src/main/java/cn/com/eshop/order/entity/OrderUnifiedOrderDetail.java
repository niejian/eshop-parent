...
* @since 2019-05-09
*/
    public class OrderUnifiedOrderDetail implements Serializable {
    ...
    private String nowProductType;
            ...
            * 产品编号(转品后)
            */
    private String nowProductCode;

            /**
            * 规格型号(转品后)
            */
    private String nowSpecification;
    ...
    private String remark;
        ...
        public Integer getFlagConvert() {
        return flagConvert;
        }

            public void setFlagConvert(Integer flagConvert) {
        ...
        return nowProductType;
            ...
            public void setNowProductType(String nowProductType) {
        this.nowProductType = nowProductType;
        }
        public String getNowProductCode() {
        return nowProductCode;
        }

            public void setNowProductCode(String nowProductCode) {
        this.nowProductCode = nowProductCode;
        }
        public String getNowSpecification() {
        return nowSpecification;
        }

            public void setNowSpecification(String nowSpecification) {
        this.nowSpecification = nowSpecification;
        }
    ...
    return "OrderUnifiedOrderDetail{" +
            "id=" + id +
            ", shopCode=" + shopCode +
            ", orderCode=" + orderCode +
            ...
            ", nowProductType=" + nowProductType +
            ", nowProductCode=" + nowProductCode +
            ", nowSpecification=" + nowSpecification +
            ", orderNum=" + orderNum +
